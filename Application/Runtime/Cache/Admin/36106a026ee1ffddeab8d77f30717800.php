                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <a class="btn btn-primary popshow" url="<?php echo U('edit_role');?>" title="新增角色" w="600" h="400">新增角色</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                                ...
                                                <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                    ...
                                                    <td>
                                                        <?php if(($vo['type']) == "1"): ?><!--管理员-->
                                                            ...
                                                            <a class="btn btn-info btn-xs" disabled >权限管理</a>
                                                        <?php else: ?>
                                                            <!--用户-->
                                                            <a class="btn btn-info btn-xs popshow" url="<?php echo U('edit_role',array('id'=>$vo['id']));?>" title="编辑角色" w="600" h="400" >编辑</a>
                                                            <a class="btn btn-info btn-xs ajax-get" msg="确认要删除该条数据吗？" url="<?php echo U('del_role',array('id'=>$vo['id']));?>">删除</a>
                                                            <a class="btn btn-info btn-xs popshow" url="<?php echo U('edit_rule',array('role_id'=>$vo['id']));?>" title="权限设置" w="600" h="400">权限管理</a><?php endif; ?>
                                                    </td>
