    ...
    <script>
        ...
        $("body").on("click",".buttonFixed>div div:nth-child(2)",function(e){
   		...
   		$("body").on("dblclick",".buttonFixed>div div:nth-child(2)",function(){
			clearTimeout(timers);
			open($(".dataTables_wrapper tbody tr").eq($(this).parents(".clearfix").index()).attr("url"),"_blank");
		})
        ...
        $("#excel").click(function(){
            ...
            var url = "<?php echo U('Excel/waters_excel');?>";
            url += '?' + data;
        ...
        function fixed(t){
        	...
        	var width = td.eq(0).outerWidth() + td.eq(1).outerWidth()+3;
        	//if(t){width = width+2}
        	...
        	//让表格高度适应屏幕
        	$(".scoll").css("height",$(".content-wrapper").height() - $(".box-header").outerHeight() - 20 - 30 - 41)
