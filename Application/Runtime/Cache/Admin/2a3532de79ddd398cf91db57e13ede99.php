                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                <a class="btn btn-primary popshow" url="<?php echo U('edit_users');?>" title="新增员工" w="600" h="500">新增员工</a>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                    ...
                                    <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <!--用户-->
                                                <?php if(($vo['status']) == "1"): ?><a class="btn btn-info btn-xs ajax-get" msg="是否冻结该员工？冻结后将不可登录" url="<?php echo U('edit_status',array('id'=>$vo['id']));?>">冻结</a>
                                                    <?php else: ?>
                                                    <a class="btn btn-info btn-xs ajax-get" msg="是否解冻该员工？解冻后将可以登录" url="<?php echo U('edit_status',array('id'=>$vo['id']));?>">解冻</a><?php endif; ?>
                                                <a class="btn btn-info btn-xs popshow" url="<?php echo U('edit_password',array('id'=>$vo['id'],'name'=>$vo['name']));?>" title="重置密码" w="600" h="400">重置密码</a>
                                                <a class="btn btn-info btn-xs ajax-get" msg="确认要删除该条数据吗？" url="<?php echo U('del_users',array('id'=>$vo['id']));?>">删除</a>
                                                <a class="btn btn-info btn-xs popshow" url="<?php echo U('edit_users',array('id'=>$vo['id']));?>" title="编辑员工" w="600" h="500">编辑</a><?php endif; ?>
                                        </td>
