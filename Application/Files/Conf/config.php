...
return array(
    ...
    'DOWNLOAD_UPLOAD' => array(
        ...
        'exts' => 'jpg,gif,png,jpeg,zip,rar,tar,gz,7z,doc,docx,txt,xml,amr,apk,mp4,csv,xls,xlsx', //允许上传的文件后缀
    ...
    'PICTURE_UPLOAD' => array(
        ...
        'hash' => true, //是否生成hash编码
        'is_water' => true, //是否水印
        'water_path' => './Public/Static/font/water.png', //水印图片
        'callback' => false, //检测文件是否存在回调函数，如果存在返回文件信息数组
    ), //图片上传相关配置（文件上传类配置）
    'PICTURE_UPLOAD_DRIVER' => 'local',
    //本地上传文件驱动配置
    'UPLOAD_LOCAL_CONFIG' => array('exts' => 'jpg,gif,png,jpeg'),
